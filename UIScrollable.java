...
public class UIScrollable {
  ...
  public void scrollIntoViewTest() {
      ...
      driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).flingForward().scrollIntoView(text(\"Tab Opener\"))")).click();
  ...
  public void getChildTest() {
      ...
      // Scroll element into view and click it
      driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).getChildByText(UiSelector().className(\"android.widget.TextView\"), \"Tab Opener\")")).click();
